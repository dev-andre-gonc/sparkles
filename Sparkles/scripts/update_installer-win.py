...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Sparkles Demo Installer\n"
      else:
        line="OutputBaseFilename=Sparkles Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Sparkles Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Sparkles installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Sparkles Demo installer\n"
     else:
       line="SetupWindowTitle=Sparkles installer\n"
