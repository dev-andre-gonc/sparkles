...
NOTARIZE_BUNDLE_ID=com.JETIstudios.Sparkles
NOTARIZE_BUNDLE_ID_DEMO=com.JETIstudios.Sparkles.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/Sparkles.iss
#  git checkout installer/Sparkles.pkgproj
